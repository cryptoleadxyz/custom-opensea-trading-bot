...
const createOffer = async () => {
  ...
  let tokenId: string = "2892"; // specific token id from the collection
  let offerAmount: string = "0.0048"; // in eth; fail if equivalent USD value is less than $5; and fail if it goes over 5th decimal places, i.e., 0.00888
